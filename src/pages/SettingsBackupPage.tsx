...
export const SettingsBackupPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      {/* User Manual & GitHub Documentation Card */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-teal-950/40 border border-teal-800/40 rounded-2xl p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                User Manual & GitHub Deployment Center
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-teal-500/15 text-teal-300 border border-teal-500/30">
                  README.md
                </span>
              </h3>
              <p className="text-xs text-slate-400">
                Complete operating manual for all 12 modules, GitHub Pages 1-click CI/CD hosting, and offline launch options.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-4 py-2.5 bg-teal-500 hover:bg-teal-400 text-slate-950 text-xs font-bold rounded-xl flex items-center gap-2 transition shadow-sm"
            >
              <BookOpen className="w-4 h-4" />
              <span>Open Interactive Manual</span>
            </button>
